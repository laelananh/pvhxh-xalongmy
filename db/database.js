...
const samplePosts = [
  {
    id: 1,
    title: 'Xã Phong Mỹ tổ chức thăm và trao quà cho các gia đình chính sách nhân ngày Thương binh - Liệt sĩ 27/7',
    slug: 'xa-my-thien-to-chuc-tham-va-trao-qua-cho-cac-gia-dinh-chinh-sach-27-7',
    category_id: 'nguoi-co-cong',
    type: 'news',
    summary: 'Sáng nay, đại diện UBND Xã Phong Mỹ và Văn phòng Xã hội đã đến thăm hỏi, trao 45 phần quà ý nghĩa cho Thương bệnh binh, Thân nhân liệt sĩ và Mẹ Việt Nam Anh hùng trên địa bàn xã.',
  ...
  {
    id: 2,
    title: 'THÔNG BÁO: Lịch chi trả trợ cấp xã hội tháng 07/2026 tại Trụ sở UBND Xã Phong Mỹ',
    slug: 'thong-bao-lich-chi-tra-tro-cap-xa-hoi-thang-07-2026',
    category_id: 'an-sinh',
    type: 'announcement',
    summary: 'Văn phòng Xã hội Xã Phong Mỹ trân trọng thông báo lịch chi trả tiền trợ cấp bảo trợ xã hội và hỗ trợ người khuyết tật, người cao tuổi tháng 07/2026.',
    content: `<p><strong>Văn phòng Xã hội Xã Phong Mỹ xin thông báo đến toàn thể nhân dân và các đối tượng thụ hưởng chính sách bảo trợ xã hội về lịch chi trả như sau:</strong></p>
    <ul>
      <li><strong>Thời gian chi trả:</strong> Ngày 20/07/2026 và 21/07/2026 (Buổi sáng: 08h00 - 11h00 | Buổi chiều: 14h00 - 16h30).</li>
      <li><strong>Địa điểm:</strong> Hội trường Bộ phận Một cửa - UBND Xã Phong Mỹ.</li>
  ...
  },
  {
    ...
    content: `<p>Thực hiện chính sách an sinh xã hội nâng cao chăm sóc sức khỏe người cao tuổi, UBND Xã Phong Mỹ phối hợp với Bảo hiểm Xã hội triển khai cấp thẻ BHYT miễn phí cho công dân từ 75 tuổi trở lên.</p>
  ...
  },
  {
    ...
    content: `<p>Văn phòng Xã hội Xã Phong Mỹ thông báo tuyển sinh các lớp học nghề ngắn hạn dành cho người lao động có hộ khẩu thường trú tại địa phương.</p>`,
...
const sampleTenders = [
  {
    ...
    investor: 'Ủy ban nhân dân Xã Phong Mỹ',
    status: 'Đang mời thầu',
    field: 'Mua sắm hàng hóa',
    deadline: '2026-08-25 17:00:00',
    published_at: '2026-07-12 09:00:00',
    content: `Dự án trang bị cơ sở vật chất cho Nhà văn hóa cộng đồng Xã Phong Mỹ.`
  },
  {
    id: 2,
    code: 'GT-MT-2026-02',
...
const sampleServices = [
  {
    ...
    fee: 'Miễn phí',
    authority: 'Ủy ban nhân dân Xã Phong Mỹ',
  ...
  },
  {
    ...
    fee: 'Miễn phí',
    authority: 'UBND Xã Phong Mỹ phối hợp BHXH Huyện',
...
let dbData = {
  ...
  settings: {
    ...
    address: 'Trụ sở UBND Xã Phong Mỹ, Ấp Mỹ Phú, Xã Phong Mỹ, Huyện Cái Bè, Tỉnh Tiền Giang',
    phone: '0273 3855 123 - Hotline: 0918 456 789',
    email: 'phongvanhoaxahoi@xaphongmy.tiengiang.gov.vn',
...
module.exports = {
  ...
  createTender: (data) => {
    ...
    const newTender = {
      ...
      investor: data.investor || 'UBND Xã Phong Mỹ',
  ...
  createService: (data) => {
    ...
    const newService = {
      ...
      authority: data.authority || 'Ủy ban nhân dân Xã Phong Mỹ',
