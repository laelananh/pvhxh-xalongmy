...
const samplePosts = [
  {
    id: 1,
    title: 'Xã Long Mỹ tổ chức thăm và trao quà cho các gia đình chính sách nhân ngày Thương binh - Liệt sĩ 27/7',
    slug: 'xa-my-thien-to-chuc-tham-va-trao-qua-cho-cac-gia-dinh-chinh-sach-27-7',
    category_id: 'nguoi-co-cong',
    type: 'news',
    summary: 'Sáng nay, đại diện UBND Xã Long Mỹ và Văn phòng Xã hội đã đến thăm hỏi, trao 45 phần quà ý nghĩa cho Thương bệnh binh, Thân nhân liệt sĩ và Mẹ Việt Nam Anh hùng trên địa bàn xã.',
  ...
  {
    id: 2,
    title: 'THÔNG BÁO: Lịch chi trả trợ cấp xã hội tháng 07/2026 tại Trụ sở UBND Xã Long Mỹ',
  ...
  },
  {
    ...
    content: `<p>Thực hiện chính sách an sinh xã hội nâng cao chăm sóc sức khỏe người cao tuổi, UBND Xã Long Mỹ phối hợp với Bảo hiểm Xã hội triển khai cấp thẻ BHYT miễn phí cho công dân từ 75 tuổi trở lên.</p>
...
const sampleTenders = [
  {
    ...
    investor: 'Ủy ban nhân dân Xã Long Mỹ',
    status: 'Đang mời thầu',
    field: 'Mua sắm hàng hóa',
    deadline: '2026-08-25 17:00:00',
    published_at: '2026-07-12 09:00:00',
    content: `Dự án trang bị cơ sở vật chất cho Nhà văn hóa cộng đồng Xã Long Mỹ.`
  },
  {
    id: 2,
    code: 'GT-MT-2026-02',
...
const sampleServices = [
  {
    ...
    fee: 'Miễn phí',
    authority: 'Ủy ban nhân dân Xã Long Mỹ',
  ...
  },
  {
    ...
    fee: 'Miễn phí',
    authority: 'UBND Xã Long Mỹ phối hợp BHXH Huyện',
...
let dbData = {
  ...
  settings: {
    site_title: 'CỔNG THÔNG TIN ĐIỆN TỬ PHÒNG VĂN HOÁ XÃ HỘI XÃ LONG MỸ',
...
module.exports = {
  ...
  createTender: (data) => {
    ...
    const newTender = {
      ...
      investor: data.investor || 'UBND Xã Long Mỹ',
  ...
  createService: (data) => {
    ...
    const newService = {
      ...
      authority: data.authority || 'Ủy ban nhân dân Xã Long Mỹ',
